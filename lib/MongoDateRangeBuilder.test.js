...
test('builds using duration strategy', t => {
  const mdr1 = new MongoDateRangeBuilder()
    .duration('week')
    .to('2017-11-18')
    .build()
  ...
  t.true(mdr1 instanceof MongoDateRange)
  t.true(mdr2 instanceof MongoDateRange)
  t.is(mdr1.start.toDayString(), '2017_11_11')
  t.is(mdr1.end.toDayString(), '2017_11_18')
  t.is(mdr2.start.toDayString(), '2017_11_27')
  t.is(mdr2.end.toDayString(), '2017_12_08')
})
