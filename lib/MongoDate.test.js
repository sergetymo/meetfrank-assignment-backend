...
test('isSame', t => {
  ...
  const md3 = new MongoDate('2018-01-01')
  t.true(md1.isSameDay('2017-12-15'))
  t.false(md1.isSameDay(md2))
  t.true(md1.isSameWeek(md2))
  t.false(md1.isSameWeek(md2, { weekStart: 0 }))
  t.true(md1.isSameMonth(md2))
  t.false(md1.isSameMonth(md3))
  t.throws(() => {
