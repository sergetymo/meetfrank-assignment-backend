...
test('modify', t => {
  const md = new MongoDate('2017-12-15')
  const minusMonth = md.modify(
    new Duration('month'),
    'back'
  )
  const plusTwoWeeks = minusMonth.add('2 weeks')
  const minusThreeDays = plusTwoWeeks.subtract('3 days')

  t.is(minusMonth.value, 1510704000000)
  t.is(plusTwoWeeks.value, 1511913600000)
  t.is(minusThreeDays.value, 1511654400000)
})
